void Mbc()
{
  ...
  TFile *input = new TFile("/home/belle2/khalid/Root_files/kaon_gen/kaongen_D_M_fit.root");
  ...
  mean_txt->DrawLatex(5.21, 1400, "#scale[0.8]{#color[6]{mean = 5.2795 GeV/C^{2}}}");
  mean_txt->Draw();
  TLatex* sigmaL_txt = new TLatex();
  sigmaL_txt->DrawLatex(5.21, 1200, "#scale[0.8]{#color[6]{#sigma_{L} = 0.002664 GeV/C^{2}}}");
  sigmaL_txt->Draw();
  TLatex* sigmaR_txt = new TLatex();
  sigmaR_txt->DrawLatex(5.21, 1000, "#scale[0.8]{#color[6]{#sigma_{R} = 0.003092 GeV/C^{2}}}");
  sigmaR_txt->Draw();
  TLatex* lower_txt = new TLatex();
  lower_txt->DrawLatex(5.21, 800, "#scale[0.8]{#color[6]{lower cut = 5.272 GeV/C^{2}}}");
  lower_txt->Draw();
  TLatex* upper_txt = new TLatex();
  upper_txt->DrawLatex(5.21, 600, "#scale[0.8]{#color[6]{upper cut = 5.289 GeV/C^{2}}}");
  upper_txt->Draw();
  TLatex* chi_txt = new TLatex();
  chi_txt->DrawLatex(5.21, 400, "#scale[0.8]{#color[6]{#chi^{2} = 1.293}}");
  chi_txt->Draw();
